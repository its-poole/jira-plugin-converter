...
/* iframe/combined/iframe-insertion.js */
/**
...
"use strict";function _defineProperty(t,e,r){return e in t?Object.defineProperty(t,e,{value:r,enumerable:!0,configurable:!0,writable:!0}):t[e]=r,t}!function(){function t(t,e){for(var r=0,i=t.length;r<i;r+=1)if(e(t[r]))return t[r]}function e(t){var e=this,r={pop:u,push:h,replace:l,change:f};if(!t.listener)throw new Error("missing listener for subscription");if(!t.type)throw new Error("missing type for subscription");if(!r[t.type])throw new Error("invalid type for subscription");this.listener=t.listener,this.type=t.type,this.eventName=r[this.type],this.lastValue=t.lastValue,this.attribute=t.attribute,this.handler=function(t){return"string"!=typeof e.attribute?e.listener(t):e.lastValue!==t[e.attribute]?(t.newURL=t[e.attribute],t.oldURL=e.lastValue,e.lastValue=t[e.attribute],e.listener(t)):void 0}}function r(t){return t.models=t.models||[],t.models instanceof Array||(t.models=[t.models]),t.models=t.models.map(function(t){return t instanceof e?t:new e(t)}),this.models=t.models,this}function i(t){return function(e){var r=d.models.filter(function(e){return e.eventName===t});r.forEach(function(t){t.handler(e)})}}function n(t){AP.history._registerWindowListeners();var r=d.find("change",t);r||(r=new e({type:"change",attribute:"hash",listener:t}),d.add(r))}function s(t,r){AP.history._registerWindowListeners();var i=d.find(t,r);if(!i){var i=new e({type:t,listener:r});d.add(i)}}function o(t,e){var r=d.find(t,e);r&&d.remove(r)}var a;if(AP._hostModules.history){var u="history_popstate",h="history_pushstate",l="history_replacestate",f="history_changestate";r.prototype.add=function(t){this.models.push(t)},r.prototype.remove=function(t){this.models.splice(this.models.indexOf(t),1)},r.prototype.find=function(e,r){return t(this.models,function(t){return t.type===e&&t.listener===r})};var d=new r({models:[]});AP.register((a={},_defineProperty(a,u,i(u)),_defineProperty(a,h,i(h)),_defineProperty(a,l,i(l)),_defineProperty(a,f,i(f)),a)),AP._hostModules.history.popState=n,AP.history.popState=n,AP._hostModules.history.subscribeState=s,AP.history.subscribeState=s,AP._hostModules.history.unsubscribeState=o,AP.history.unsubscribeState=o;var c=null;AP.history.getState("all",function(t){c=t}),AP.history.subscribeState("change",function(t){c=t});var p=AP._hostModules.history.getState.bind({});AP.history.getState=AP._hostModules.history.getState=function(t,e){if(e=arguments[arguments.length-1],"function"==typeof e)return"string"==typeof t?p(t,e):p(e);if(t=t||"hash","hash"===t)return c&&c.hash?c.hash:"";if("all"===t)return c;throw new Error("invalid type for getState")}}}();
...
/* iframe/plugin/dropdown-list.js */
(function() {
    if (!AP.dropdownList) {
        return;
    }
